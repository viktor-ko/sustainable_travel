...
This project is a web application that helps users compare the CO2 emissions and travel duration between train and plane for their trips. The application is built using Streamlit, Pandas, and Altair.
